...
function FacebookConnect(autologin, initCallback) {
	...
	var AppId = '571225799583152'; // App ID/API Key
	var perms = 'read_stream,publish_stream,offline_access,user_photos,email,user_likes'; // Scope to access data
	var Channel = 'http://local.clarusdigital.com/Facebook_demo/'; // custom channel
	var AppUrl = 'http://local.clarusdigital.com/Facebook_demo/';
