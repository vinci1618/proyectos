...
public void eegEvent(int delta, int theta, int low_alpha, int high_alpha, int low_beta, int high_beta, int low_gamma, int mid_gamma) {
  ...
  _delta = delta/1000;
  _theta = theta/1000;
  _low_alpha  = low_alpha/1000;
  _high_alpha = high_alpha/1000; 
  _low_beta = low_beta/1000;
  _high_beta = high_beta/1000;
  _low_gamma = low_gamma/1000;
  _mid_gamma = mid_gamma/1000;
 
//  println("delta Level: " + _delta);
//  println("theta Level: " + _theta);
//  println("low_alpha Level: " + _low_alpha);
//  println("high_alpha Level: " + _high_alpha);
//  println("low_beta Level: " + _low_beta);
//  println("high_beta Level: " + _high_beta);
//  println("low_gamma Level: " + _low_gamma);
//  println("mid_gamma Level: " + _mid_gamma);
}
...
class Particle
{
  final static float RAD = 8;//4;
  final static float BOUNCE = -1;
  final static float SPEED_MAX = 5; //2.2;
